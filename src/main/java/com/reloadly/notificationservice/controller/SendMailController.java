...
//final EmailDto emailDto or i  can use @ModelAttribute annotation

    @PostMapping
    public ResponseEntity<ApiResponse<Boolean>> sendMail(@RequestBody @Valid @ModelAttribute ("emailDto") EmailDto emailDto) {
